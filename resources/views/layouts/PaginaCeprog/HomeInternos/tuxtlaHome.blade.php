...
@section('content_tuxtlaHome')
    ...
    <div id="flexslider-principal" class="flexslider">
                ...
                <div class="principal-background"></div>
                 ...
                 <nav>
                    ...
                    <ul class="slides">
                        <li><img src="image/banner_tuxtla/tuxtla_banner1.JPG" alt="" /></li>
                        <li><img src="image/banner_tuxtla/tuxtla_banner2.JPG" alt="" /></li>
                        <li><img src="image/banner_tuxtla/tuxtla_banner3.JPG" alt="" /></li>
                        <li><img src="image/banner_tuxtla/tuxtla_banner4.JPG" alt="" /></li>                    
                    </ul>
                    <div class="slider-content"><img src="image/mensaje_rector/logos/ceprog_logo_home_tuxtla.png" alt="" />
                    </div>
    ...
    <div id="work" class="m-b-40">
        <div class="container">
            ...
            <div id="campus-tuxtla" class="sixteen columns">
                <h2>Campus Tuxtla  Gutiérrez</h2>
            ...
            <div class="sixteen columns">
                <div id="flexslider-fotos" class="flexslider">
                    <ul class="slides">
                        <li><img src="image/fotos/tuxtla/foto1.jpg" alt="" /></li>
                        <li><img src="image/fotos/tuxtla/foto2.jpg" alt="" /></li>
                        <li><img src="image/fotos/tuxtla/foto3.jpg" alt="" /></li>
                        <li><img src="image/fotos/tuxtla/foto4.jpg" alt="" /></li>
                        <li><img src="image/fotos/tuxtla/foto5.jpg" alt="" /></li>
                        <li><img src="image/fotos/tuxtla/foto6.jpg" alt="" /></li>
                    </ul>
                </div><!-- end flexslider -->
                <a href="{{ route('galeriaTuxtla') }}" class="textlink m-l-20">» Ver más fotos</a>
            </div> <!-- end sixteen columns -->
            ...
            <div class="portfolioContainer m-b-100">
                ...
                <div class="web">
                    <div class="one-third column">
                        <div class="image">
                        <a href="{{ route('ofertaTuxtla') }}#tab3">
                            <img src="image/fotos/oferta_preparatoria.jpg" class="scale-with-grid" alt="Preparatoria" />
                ...
                <div class="web">
                    <div class="one-third column">
                        <div class="image">
                            <a href="{{ route('ofertaTuxtla') }}#tab2">
    ...
    <div id="separator2" class="smallS">
        ...
        <div class="container">
            ...
            <div class="eight columns">
                <img src="image/fotos/servicios_campus/servicios_tuxtla.jpg"  alt="Servicios"/>
            </div>
            <div class="eight columns">
...
» Áreas verdes
                ...
                <a href="{{ route('servicioTuxtla') }}" class="button2 darkback">Ver más</a>
            </div>           
        </div>
