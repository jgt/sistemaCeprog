...
@section('content_adminEmpresas')
	...
	<div class="header-sitio interno">
   	...
   	<div class="subtitulo carrera">
        	<div class="container">				
			<div class="sixteen columns ">
	        	<p><a href="{{ route('palenqueHome') }}">Inicio</a> / <a href="{{ route('ofertaPalenque') }}">Oferta Educativa</a> / <a href="{{ route('ofertaPalenque') }}#tab1">Licenciaturas</a> / <span>Administración de Empresas</span></p>
            </div>
            </div>
    ...
    <div class="carrera-cont">
        <div class="container principal">				
                ...
                <div class="six columns">
                    ...
                    <a href="palenque_contactanos.html" class="mandar-comentarios">¿Comentarios o sugerencias? <span>¡Escríbenos!</span></a>   
