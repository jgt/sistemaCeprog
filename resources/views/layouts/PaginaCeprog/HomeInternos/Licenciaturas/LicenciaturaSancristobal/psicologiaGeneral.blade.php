...
@section('content_psicologiaGeneralSancristobal')
...
<div class="header-sitio interno">
   	...
   	<div class="subtitulo carrera">
        	<div class="container">				
			<div class="sixteen columns ">
	        	<p><a href="{{ route('sancristobalHome') }}">Inicio</a> / <a href="{{ route('ofertaSancristobal') }}">Oferta Educativa</a> / <a href="{{ route('ofertaSancristobal') }}#tab1">Licenciaturas</a> / <span>Licenciatura en Psicología General</span></p>
            </div>
            </div>
    ...
    <div class="carrera-cont">
        <div class="container principal">				
                <div class="sixteen columns ">
                    ...
                    <img src="image/fotos/sancristobal/psicologia.jpg" alt="Administración de Empresas" />
                </div> 
