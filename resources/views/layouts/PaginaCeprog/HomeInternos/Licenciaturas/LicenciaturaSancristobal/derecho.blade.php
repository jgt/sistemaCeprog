...
@section('content_derechoSancristobal')
...
<div class="header-sitio interno">
   	...
   	<div class="subtitulo carrera">
        	<div class="container">				
			<div class="sixteen columns ">
	        	<p><a href="{{ route('sancristobalHome') }}">Inicio</a> / <a href="ofertaSancristobal">Oferta Educativa</a> / <a href="{{ route('ofertaSancristobal') }}#tab1">Licenciaturas</a> / <span>Licenciatura en Derecho</span></p>
            </div>
            </div>
...
Todos los Derechos Reservados. 2014.</p>
	...
	<div id="footer-bb">
		<div class="container">				
			<div class="sixteen columns">
				<div class="copyright">
					<p><span></span>Sitio desarrollado por UnversidadCeprog/Ing.Galvis Tellez</p>
				</div>
			</div>
