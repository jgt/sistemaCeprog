...
@section('content_adminEmpresasTuristicasSancristobal')
 ...
 <div class="header-sitio interno">
   	...
   	<div class="subtitulo carrera">
        	<div class="container">				
			<div class="sixteen columns ">
	        	<p><a href="{{ route('sancristobalHome') }}">Inicio</a> / <a href="{{ route('ofertaSancristobal') }}">Oferta Educativa</a> / <a href="{{ route('ofertaSancristobal') }}#tab1">Licenciaturas</a> / <span>Administración de Empresas Turísticas</span></p>
            </div>
            </div>
