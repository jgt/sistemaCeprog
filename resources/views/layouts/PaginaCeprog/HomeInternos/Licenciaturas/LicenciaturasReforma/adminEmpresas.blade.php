...
@section('content_adminEmpresasReforma')
...
<div class="header-sitio interno">
   	...
   	<div class="subtitulo carrera">
        	<div class="container">				
			<div class="sixteen columns ">
	        	<p><a href="{{ route('reformaHome') }}">Inicio</a> / <a href="{{ route('ofertaReforma') }}">Oferta Educativa</a> / <a href="{{ route('ofertaReforma') }}#tab1">Licenciaturas</a> / <span>Administración de Empresas</span></p>
            </div>
            </div>
