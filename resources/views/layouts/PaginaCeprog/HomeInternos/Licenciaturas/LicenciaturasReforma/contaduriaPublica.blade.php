...
@section('content_contaduriaPublicaReforma')
...
<div class="header-sitio interno">
   	...
   	<div class="subtitulo carrera">
        	<div class="container">				
			<div class="sixteen columns ">
	        	<p><a href="{{ route('reformaHome') }}">Inicio</a> / <a href="{{ route('ofertaReforma') }}">Oferta Educativa</a> / <a href="{{ route('ofertaReforma') }}#tab1">Licenciaturas</a> / <span>Licenciatura en Contaduría Pública</span></p>
            </div>
            </div>
    ...
    <div class="carrera-cont">
        <div class="container principal">				
                <div class="sixteen columns ">
                    ...
                    <img src="image/fotos/reforma/contaduria.jpg" alt="Administración de Empresas" />
                </div> 
