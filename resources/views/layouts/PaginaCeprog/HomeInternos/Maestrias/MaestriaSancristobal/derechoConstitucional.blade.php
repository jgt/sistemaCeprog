...
@section('content_maestriaDerechoConstitucionalSancristobal')
...
<div class="header-sitio interno">
   	...
   	<div class="subtitulo carrera">
        	<div class="container">				
			<div class="sixteen columns ">
	        	<p><a href="{{ route('sancristobalHome') }}">Inicio</a> / <a href="{{ route('ofertaSancristobal') }}">Oferta Educativa</a> / <a href="{{ route('ofertaSancristobal') }}#tab1">Posgrados</a> / <span>Maestría Derecho Constitucional y Amparo</span></p>
            </div>
            </div>
