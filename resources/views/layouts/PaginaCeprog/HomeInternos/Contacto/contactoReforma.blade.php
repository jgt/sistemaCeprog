...
@section('content_contactoReforma')
    ...
    <div id="separator6">
		...
		<div class="subtitulo">
        	<div class="container">				
			<div class="sixteen columns ">
	        	<p><a href="{{ route('reformaHome') }}">Inicio</a> / <span><strong>Contáctanos</strong></span></p>
            </div>
            </div>
        </div>
    ...
    <div class="datos-contacto">
    	 <div class="container">
            <div class="sixteen columns">
		    	<h1>Universidad CEPROG - Campus Reforma</h1>
        	</div>
            <div class="four columns">
            	<p><span>Dirección:</span>
                Campus Reforma - Carretera Federal Reforma Juárez km. 1<br>
               Reforma, Chiapas, C.P. 29500
              </p>
            </div>
            <div class="four columns">
            	<p><span>Horario:</span>
            ...
            <div class="four columns">
                ...
                (917) 117 3748 y (961) 117 7966
              </p>
            </div>
            <div class="four columns">
            	<p><span>E-Mail:</span>
                <a href="mailto:admisiones.reforma@uceprog.edu.mx">admisiones.reforma@uceprog.edu.mx</a>
        ...
        <div class="container principal">
             ...
             <div id="seccionForma" class="fourteen columns offset-by-one">
                    ...
                    <span class="campos-req">*Campos requeridos</span>
                     ...
                     <form id="ajax-form" action="reforma.php" method="post">
                                    <div class="row">
                                        ...
                                        <div class="fourteen columns alpha">
                                            <div class="styled-select">
                                             <select id="motivo" name="motivo">
                                                  ...
                                                  <option value="1">Iformacion sobre Licenciaturas</option>
                                             </select> 
                                             </div>
