...
@section('content_contactoTuxtla')
    ...
    <div id="separator6">
		...
		<div class="subtitulo">
        	<div class="container">				
			<div class="sixteen columns ">
	        	<p><a href="{{ route('tuxtlaHome') }}">Inicio</a> / <span><strong>Contáctanos</strong></span></p>
            </div>
            </div>
        </div>
    ...
    <div class="datos-contacto">
    	 <div class="container">
            <div class="sixteen columns">
		    	<h1>Universidad CEPROG - Campus Tuxtla</h1>
        	</div>
            <div class="four columns">
            	<p><span>Dirección:</span>
                Campus Tuxtla - Boulevard Ángel Albino Corzo, No. 1089-B, Colonia La Salle 1. Tuxtla Gutiérrez, Chiapas, C.P. 29070</p>
            </div>
            <div class="four columns">
            	<p><span>Horario:</span>
            ...
            <div class="four columns">
            	<p><span>E-Mail:</span>
                <a href="mailto:admisiones.tuxtla@uceprog.edu.mx">admisiones.tuxtla@uceprog.edu.mx</a>
        ...
        <div class="container principal">
             ...
             <div id="seccionForma" class="fourteen columns offset-by-one">
                    ...
                    <span class="campos-req">*Campos requeridos</span>
                     ...
                     <form id="ajax-form" action="tuxtla.php" method="post">
                                    <div class="row">
